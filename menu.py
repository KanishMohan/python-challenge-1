...
order_list = dict ["Item Name": "string", "Price": float,"Quantity": int]
order = []
...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            # else:
            #     print("You didn't input a valid item number")
                ...
                if menu_selection in menu_items.keys(): 
                    ...
                    item_quantity = input("Type the quantity of the menu items: ")
